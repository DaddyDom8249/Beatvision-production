...
describe("World Report contract",()=>{it("requires song_summary",()=>expect(required).toContain("song_summary"));it("has 12 required fields",()=>expect(required).toHaveLength(12));});
